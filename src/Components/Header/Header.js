            ...
            <div className='iq-navbar-logo d-flex align-items-center justify-content-between'>
              ...
              <Link to='/dashboard'>
                <img
                  ...
                  alt='logo'
                />
                <h5 className='logo-title ml-3'>BACANCY</h5>
              </Link>
            </div>
            <div className='iq-search-bar device-search'>
              <form action='#' className='searchbox'>
                <a className='search-link' href='#'>
                  <i className='fas fa-search' style={{ color: '#F68122' }}></i>
                </a>
                <input
                  type='text'
                    ...
                    >
                      <div className='card shadow-none m-0'>
                        <div className='card-body p-0 text-center'>
                          ...
                          <div className='p-3'>
                            <h5 className='mb-1'> {userProfile.email}</h5>
                            <p
                              className='mb-0'
                              style={{
                                fontWeight: 'bold',
                ...
                <div className='content create-workform bg-body'>
                  ...
                  <div className='pb-3'>
                    ...
                    <input
                      ...
                      readOnly={true}
                      value={
                        userProfile.branch_id === 1
                          ? '8th Floor, Thaltej'
                          : userProfile.branch_id === 2
                          ? '12th Floor, Thaltej'
